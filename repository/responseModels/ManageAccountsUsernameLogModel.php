...
class ManageAccountsUsernameLogModel extends AccountsUsernameLogAR
{
    /**
    * @inheritdoc
    */
    public function fields()
    {
        ...
        $fields['before_username'] = function(){
            return $this->before_username;
        };
        $fields['new_username'] = function(){
